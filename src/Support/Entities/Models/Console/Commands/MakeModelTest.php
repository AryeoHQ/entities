...
class MakeModelTest extends TestCase implements TestsGeneratesEntity
{
    ...
    public function model_related_files_are_created(): void
    {
        ...
        $this->assertTrue(File::exists($this->entity->factory->filePath->toString()));
        $this->assertTrue(File::exists($this->entity->builder->filePath->toString()));
        ...
        $this->assertTrue(File::exists($this->entity->collection->filePath->toString()));
        $this->assertTrue(File::exists($this->entity->factory->test->filePath->toString()));
        $this->assertTrue(File::exists($this->entity->builder->test->filePath->toString()));
        $this->assertTrue(File::exists($this->entity->collection->test->filePath->toString()));
    }
    ...
    public function model_contains_the_correct_attributes(): void
    {
        ...
        $model = File::get($this->entity->filePath->toString());
    ...
    public function model_creates_and_registers_semantic_events(): void
    {
        ...
        foreach ((new class // @phpstan-ignore class.missingExtends
        {
            ...
            $this->assertTrue(File::exists($ref->filePath->toString()));
        }
    }
    ...
    public function no_factory_omits_factory_from_model(): void
    {
        ...
        $this->assertFalse(File::exists($this->entity->factory->filePath->toString()));
        $this->assertFalse(File::exists($this->entity->factory->test->filePath->toString()));
    }
    ...
    public function no_builder_omits_builder_from_model(): void
    {
        ...
        $this->assertFalse(File::exists($this->entity->builder->filePath->toString()));
        $this->assertFalse(File::exists($this->entity->builder->test->filePath->toString()));
    }
    ...
    public function no_collection_omits_collection_from_model(): void
    {
        ...
        $this->assertFalse(File::exists($this->entity->collection->filePath->toString()));
        $this->assertFalse(File::exists($this->entity->collection->test->filePath->toString()));
    }
    ...
    public function no_events_omits_events_from_model(): void
    {
        ...
        foreach ((new class // @phpstan-ignore class.missingExtends
        {
            ...
            $this->assertFalse(File::exists($this->entity->event($event)->filePath->toString()));
        }
    }
    ...
    public function no_policy_omits_policy_from_model(): void
    {
        ...
        $this->assertFalse(File::exists($this->entity->policy->test->filePath->toString()));
    }
    ...
    public function no_test_skips_test_file(): void
    {
        ...
        $this->assertTrue(File::exists($this->entity->filePath->toString()));
        $this->assertFalse(File::exists($this->entity->test->filePath->toString()));
    }
