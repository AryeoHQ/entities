...
namespace Support\Entities\Events\Dispatcher\Mixins;
...
use Tests\Fixtures\Support\Posts\Events\DisablesModelSerialization;
use Tests\Fixtures\Support\Posts\Events\DisablesModelSerializationThroughInterface;
...
class DisablesSerializesModelsTest extends TestCase
{
    ...
    public function it_disables_model_serialization_within_the_closure(): void
    {
        ...
        $this->assertInstanceOf(Post::class, $serialized['entity']);
    }
    ...
    public function it_returns_the_closure_result(): void
    {
        ...
        $event = Event::withoutSerializesModels(fn () => new Created($post));
    ...
    public function it_disables_model_serialization_for_a_specific_event_class(): void
    {
        ...
        Event::withoutSerializesModels(DisablesModelSerialization::class, function () use (&$serialized) {
            $event = new DisablesModelSerialization(Post::factory()->make());
            $serialized = $event->__serialize();
        });
    ...
    public function it_disables_model_serialization_for_an_array_of_event_classes(): void
    {
        ...
        Event::withoutSerializesModels(
            ...
            function () use (&$first, &$second) {
                $first = (new DisablesModelSerialization(Post::factory()->make()))->__serialize();
                $second = (new DisablesModelSerializationThroughInterface(Post::factory()->make()))->__serialize();
            },
        );

        $this->assertInstanceOf(Post::class, $first['entity']);
        $this->assertInstanceOf(Post::class, $second['entity']);
    }
    ...
    public function it_disables_model_serialization_for_events_matching_an_interface(): void
    {
        ...
        Event::withoutSerializesModels(\Stringable::class, function () use (&$serialized) {
            $event = new DisablesModelSerializationThroughInterface(Post::factory()->make());
            $serialized = $event->__serialize();
        });
