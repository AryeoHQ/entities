...
final class SerializesModelsTest extends TestCase
{
    ...
    {
        $notPersisted = Post::factory()->make();
    ...
    {
        $serialized = with( // @phpstan-ignore argument.templateType
            new DisablesModelSerialization(Post::factory()->make()),
    ...
    {
        $serialized = with( // @phpstan-ignore argument.templateType
            new DisablesModelSerializationThroughInterface(Post::factory()->make()),
